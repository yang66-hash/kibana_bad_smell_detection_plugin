...
import type { APIReturnType } from '../../../../services/rest/create_call_bsd_api';
...
export function IndexStatsPerService({ indicesStats, status }: Props) {
  ...
  const columns: Array<EuiBasicTableColumn<ValuesType<StorageExplorerIndicesStats>>> = [
    ...
    },
    {
      field: 'size',
      name: <SizeLabel />,
      render: (_, { size }) => asDynamicBytes(size) ?? "N/A",
      sortable: true,
    },
    {
      field: 'dataStream',
    ...
    },
    {
      ...
      render: (_, { lifecyclePhase }) => lifecyclePhase ?? "N/A",
      sortable: true,
    },
  ];
