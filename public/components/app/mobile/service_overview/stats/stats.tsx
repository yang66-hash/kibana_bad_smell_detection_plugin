...
export function MobileStats({ start, end, kuery }: { start: string; end: string; kuery: string }) {
  ...
  } = useAnyOfBSDParams('/mobile-services/{serviceName}/overview');
  ...
  const metrics: MetricDatum[] = [
    ...
    },
    {
      ...
      valueFormatter: (value: number) =>
        Number.isNaN(value) ? "N/A" : valueFormatter(Number(value.toFixed(1)), 'ms'),
    ...
    },
    {
      ...
      valueFormatter: (value: number) =>
        Number.isNaN(value) ? "N/A" : valueFormatter(value),
