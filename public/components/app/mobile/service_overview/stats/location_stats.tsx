...
import { CLIENT_GEO_COUNTRY_NAME } from '../../../../../../common/es_fields/bsd';
  ...
  const metrics: MetricDatum[] = [
    {
      ...
      value: currentPeriod?.mostRequests.location ?? "N/A",
    ...
    },
    {
      ...
      icon: getIcon('bug'),
      value: currentPeriod?.mostCrashes.location ?? "N/A",
      valueFormatter: (value) => `${value}`,
    ...
    },
    {
      ...
      value: currentPeriod?.mostSessions.location ?? "N/A",
      valueFormatter: (value) => `${value}`,
    ...
    },
    {
      ...
      icon: getIcon('launch'),
      value: currentPeriod?.mostLaunches.location ?? "N/A",
      valueFormatter: (value) => `${value}`,
