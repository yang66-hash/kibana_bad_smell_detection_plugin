...
//   const agentConfigurationAvailable = useBSDFeatureFlag(
//     ApmFeatureFlagName.AgentConfigurationAvailable
//   );
//   const migrationToFleetAvailable = useBSDFeatureFlag(ApmFeatureFlagName.MigrationToFleetAvailable);
//   const indicesAvailable = useBSDFeatureFlag(ApmFeatureFlagName.ConfigurableIndicesAvailable);
