...
import { ErrorDetailLink } from '../links/apm/mobile/error_detail_link';
import { ErrorOverviewLink } from '../links/apm/mobile/error_overview_link';
...
export function getColumns({
  ...
  query: TypeOf<BSDRoutes, '/services/{serviceName}/errors'>['query'];
              ...
              return (
                <ErrorLink
                  ...
                  query={
                    ...
                    } as TypeOf<BSDRoutes, '/services/{serviceName}/errors'>['query']
                  }
                >
                  {type}
                </ErrorLink>
