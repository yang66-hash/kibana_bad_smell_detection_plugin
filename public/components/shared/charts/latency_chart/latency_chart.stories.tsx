...
import { MockApmPluginContextWrapper } from '../../../../context/bsd_plugin/mock_bsd_plugin_context';
import { BSDServiceContext } from '../../../../context/bsd_service/bsd_service_context';
...
import { APIReturnType, createCallBSDApi } from '../../../../services/rest/create_call_bsd_api';
...
const stories: Meta<Args> = {
  ...
  decorators: [
    (StoryComponent, { args }) => {
      ...
      createCallBSDApi(apmPluginContextMock.core);

      mockBSDApiCallResponse(
