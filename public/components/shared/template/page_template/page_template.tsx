...
export interface BSDPageTemplateDependencies {
...
export type BSDPageTemplateProps = Omit<
  BSDPageTemplateDependencies,
  'isSidebarEnabled$'
> &
  WrappedPageTemplateProps;

export function BSDPageTemplate({
  children,
  currentAppId$,
  getUrlForApp,
  navigateToApp,
  ...
  topSearchBar,
  ...pageTemplateProps
}: BSDPageTemplateProps): React.ReactElement | null {
...
export default BSDPageTemplate;

const sideNavTitle = 'BSD';
...
export function createLazyBSDPageTemplate(
  injectedDeps: BSDPageTemplateDependencies
) {
  return (pageTemplateProps: LazyBSDPageTemplateProps) => (
    <React.Suspense fallback={null}>
      <LazyBSDPageTemplate {...pageTemplateProps} {...injectedDeps} />
    </React.Suspense>
  );
}
