...
import { bSDRouter as bSDRouterBase, BSDRouter } from '../../routing/bsd_route_config';
import { logsLocatorsMock } from '../../../context/bsd_plugin/mock_bsd_plugin_context';
import { sharePluginMock } from '@kbn/share-plugin/public/mocks';

const bSDRouter = {
  ...bSDRouterBase,
  link: (...args: [any]) => `some-basepath/app/bsd${bSDRouterBase.link(...args)}`,
} as BSDRouter;
          ...
          actions: [
            {
              ...
              href: 'some-basepath/app/bsd/service-map?comparisonEnabled=false&environment=ENVIRONMENT_ALL&kuery=trace.id%20%3A%20%22123%22&rangeFrom=now-24h&rangeTo=now&serviceGroup=',
              condition: true,
            },
          ],
        },
