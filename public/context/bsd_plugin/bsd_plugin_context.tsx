...
import type { BSDPluginSetupDeps } from '../../plugin';
import type { ConfigSchema } from '../..';
import type { KibanaEnvContext } from '../kibana_environment_context/kibana_environment_context';

export interface BSDPluginContextValue {
  appMountParameters: AppMountParameters;
  config: ConfigSchema;
  core: CoreStart;
  inspector: InspectorPluginStart;
  plugins: BSDPluginSetupDeps & { maps?: MapsStartApi };
...
export const BSDPluginContext = createContext({} as BSDPluginContextValue);
