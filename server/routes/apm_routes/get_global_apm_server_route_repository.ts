...
export type BSDServerRouteRepository = ReturnType<typeof getTypedGlobalApmServerRouteRepository>;

// Ensure no APIs return arrays (or, by proxy, the any type),
// to guarantee compatibility with _inspect.

export type APIEndpoint = EndpointOf<BSDServerRouteRepository>;

type EndpointReturnTypes = {
  [Endpoint in APIEndpoint]: ReturnOf<BSDServerRouteRepository, Endpoint>;
};
